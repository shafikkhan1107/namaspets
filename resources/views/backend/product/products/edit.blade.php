...
<!--                        <div class="form-group row">
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row" id="quantity">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" lang="en" value="{{ (!empty($product->stocks->first()->qty)) ? $product->stocks->first()->qty : '' }}" step="1" placeholder="{{translate('Quantity')}}" name="current_stock" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="{{ translate('SKU') }}" value="{{ (!empty($product->stocks->first()->sku)) ?  $product->stocks->first()->sku : ''}}" name="sku" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br>

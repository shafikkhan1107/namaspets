        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6"> 
                    <div class="animal-box">
                        <div class="top-icon">
                            <div class="d-flex social-icon"><a data-bss-hover-animate="bounce" class="icon" href="#">
								<div><svg viewBox="0 0 24 24">
									<path d="M17.525,9H14V7c0-1.032,0.084-1.682,1.563-1.682h1.868v-3.18C16.522,2.044,15.608,1.998,14.693,2C11.98,2,10,3.657,10,6.699V9H7v4l3-0.001V22h4v-9.003l3.066-0.001L17.525,9z"></path>
								</svg></div>
                                </a><a data-bss-hover-animate="bounce" class="icon" href="#">
								<div><svg viewBox="0 0 48 48">
									<path d="M44.719,10.305C44.424,10,43.97,9.913,43.583,10.091l-0.164,0.075c-0.139,0.064-0.278,0.128-0.418,0.191c0.407-0.649,0.73-1.343,0.953-2.061c0.124-0.396-0.011-0.829-0.339-1.085c-0.328-0.256-0.78-0.283-1.135-0.066c-1.141,0.693-2.237,1.192-3.37,1.54C37.4,7.026,35.071,6,32.5,6c-5.247,0-9.5,4.253-9.5,9.5c0,0.005,0,0.203,0,0.5l-0.999-0.08c-9.723-1.15-12.491-7.69-12.606-7.972c-0.186-0.47-0.596-0.813-1.091-0.916C7.81,6.927,7.297,7.082,6.939,7.439C6.741,7.638,5,9.48,5,13c0,2.508,1.118,4.542,2.565,6.124c-0.674-0.411-1.067-0.744-1.077-0.753c-0.461-0.402-1.121-0.486-1.669-0.208c-0.546,0.279-0.868,0.862-0.813,1.473c0.019,0.211,0.445,4.213,5.068,7.235l-0.843,0.153c-0.511,0.093-0.938,0.444-1.128,0.928C6.914,28.437,6.988,28.984,7.3,29.4c0.105,0.141,2.058,2.68,6.299,4.14C11.334,34.295,8.222,35,4.5,35c-0.588,0-1.123,0.344-1.366,0.88c-0.244,0.536-0.151,1.165,0.237,1.607C3.532,37.672,7.435,42,17.5,42C34.213,42,42,26.485,42,16v-0.5c0-0.148-0.016-0.293-0.022-0.439c2.092-2.022,2.879-3.539,2.917-3.614C45.084,11.067,45.014,10.609,44.719,10.305z"></path>
								</svg></div>
                                </a><a data-bss-hover-animate="bounce" class="icon" href="#">
                            ...
                            <div class="animal-div"><img class="img-fluid" src="/public/namas-pet/NP-HTML/assets/img/animal1.png" /></div>
						</div>
                ...
                <div class="col-lg-4">
                    <div class="d-flex flex-column top-end">
                        <div class="head-btn">
                            <div>
								<div> <a href="#" data-bss-hover-animate="tada" ><img class="img-fluid icon" src="/public/namas-pet/NP-HTML/assets/img/phone.svg" />Call 01204 848181</a> </div>
								<div> <a href="#" data-bss-hover-animate="tada" ><img class="img-fluid icon" src="/public/namas-pet/NP-HTML/assets/img/whatsapp.svg" />+44 7897 543210</a> </div>
							</div>
                            <div> <a href="{{ route('user.registration') }}" class="btn btn-primary"  data-bss-hover-animate="tada" type="button">SHOP NOW</a> </div>
                            
						</div>
                        <div class="cart"><a data-bss-hover-animate="tada" class="user icon-svg" href="#">
							<div><svg viewBox="0 0 24 24">
							...
							</svg></div><a href="{{ route('user.login') }}"><span class="shopping-box">Login</span></a>
						</a>
						<a data-bss-hover-animate="tada" class="heart icon-svg" href="{{ route('wishlists.index') }}">
							...
							</svg></div><span class="shopping-box">Wishlist</span>
						</a>
						<a data-bss-hover-animate="tada" class="sho-cart icon-svg" href="#">
							...
							</svg></div><span class="shopping-box">Cart</span>
						</a></div>
					</div>
				</div>
			</div>
    ...
    <div class="header-bottom">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="container-fluid"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                            <div class="collapse navbar-collapse nav-top" id="navcol-1">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <!-- <li class="nav-item"><a class="nav-link" data-bss-hover-animate="jello" href="#">PET FOOD</a></li> -->
									
                                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" data-bss-hover-animate="jello" href="#">PET FOOD</a>
										<div class="dropdown-menu"><a class="dropdown-item" href="#">Dog Food</a><a class="dropdown-item" href="#">Cat Food</a><a class="dropdown-item" href="#">Bird Food</a><a class="dropdown-item" href="#">Reptile Food</a><a class="dropdown-item" href="#">Amphibian Food</a><a class="dropdown-item" href="#">Small Animals</a></div>
									</li>
									
                                    <!-- <li class="nav-item"><a class="nav-link" data-bss-hover-animate="jello" href="#">FROZEN RAW FOOD</a></li> -->
									
                                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" data-bss-hover-animate="jello" href="#">FROZEN RAW FOOD</a>
										<div class="dropdown-menu"><a class="dropdown-item" href="#">Dogs</a><a class="dropdown-item" href="#">Cats</a><a class="dropdown-item" href="#">Raw Treats</a></div>
									</li>
									
                                    <li class="nav-item"><a class="nav-link" data-bss-hover-animate="jello" href="#">NATURAL DRY TREATS</a></li>
                                    <!-- <li class="nav-item"><a class="nav-link" data-bss-hover-animate="jello" href="#">ANIMALS TOYS</a></li> -->
                                    
                                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" data-bss-hover-animate="jello" href="#">ANIMALS TOYS</a>
										<div class="dropdown-menu"><a class="dropdown-item" href="#">Dogs</a><a class="dropdown-item" href="#">Parrots</a><a class="dropdown-item" href="#">Cats</a><a class="dropdown-item" href="#">Small Animals</a></div>
									</li>
									
                                    <li class="nav-item"><a class="nav-link" data-bss-hover-animate="jello" href="#">MORE</a></li>
								</ul>
                ...
                <div class="col-lg-1">
                    <div class="cart"><a data-bss-hover-animate="tada" class="user icon-svg" href="#"><div>
                        ...
                        </div><span class="shopping-box">Login</span></a><a data-bss-hover-animate="tada" class="sho-cart icon-svg" href="#"><div>
					...
					</div><span class="shopping-box">Cart</span></a></div>
				</div>
			</div>
		</div>
	</div>

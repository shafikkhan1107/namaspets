...
<html dir="rtl" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
		...
		<head>
			...
			<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&family=Teko:wght@400;700&display=swap" rel="stylesheet"> 
			
			<!-- CSS Files -->
			
			<link rel="stylesheet" href="{{ static_asset('namas-pet/NP-HTML/assets/bootstrap/css/bootstrap.min.css') }}">
			...
			<link rel="stylesheet" href="{{ static_asset('namas-pet/NP-HTML/assets/css/styles1.min.css') }}">
  ...
  new google.translate.TranslateElement({pageLanguage: 'hr'}, 'google_translate_element');
		...
		<body>
			...
			<!-- SCRIPTS -->
			<script src="{{ static_asset('namas-pet/NP-HTML/assets/js/jquery.min.js') }}"></script>
			<script src="{{ static_asset('namas-pet/NP-HTML/assets/bootstrap/js/bootstrap.min.js') }}"></script>
			<script>
$.noConflict();
// Code that uses other library's $ can follow here.
			...
			<script src="{{ static_asset('namas-pet/NP-HTML/assets/js/script.min.js') }}"></script>
			...
			<script>
				...
				function getVariantPrice(){
					...
					// alert($('#option-choice-form').serializeArray())
						$.ajax({
							type:"POST",

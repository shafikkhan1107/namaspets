...
@section('content')
    <section class="pt-5 pb-4 bg-sec-light">
        <div class="container">
                        ...
                        <div class="text-left">
                            ...
                            @if(home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-sm-12">
                                        <div class="opacity-50 my-0">{{ translate('Price')}}:</div>
                                    </div>
                                    <div class="col-sm-12">
                            ...
                            @if (\App\Addon::where('unique_identifier', 'club_point')->first() != null && \App\Addon::where('unique_identifier', 'club_point')->first()->activated && $detailedProduct->earn_point > 0)
                                <div class="row no-gutters mt-4">
                                    <div class="col-sm-12">
                                        <div class="opacity-50 my-0">{{  translate('Club Point') }}:</div>
                                    </div>
                                    <div class="col-sm-12">
                            ...
                            <form id="option-choice-form">
                                ...
                                @if (count(json_decode($detailedProduct->colors)) > 0)
                                    <div class="row no-gutters">
                                        <div class="col-sm-12">
                                            <div class="opacity-50 my-0">{{ translate('Color')}}:</div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="aiz-radio-inline">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-12">
                                        <div class="opacity-50 my-0">{{ translate('Quantity')}}:</div>
                                    </div>
                                    <div class="col-sm-12">
                                ...
                                <div class="row no-gutters my-3 d-none" id="chosen_price_div">
                                    <div class="col-sm-12">
                                        <div class="opacity-50 my-0">{{ translate('Total Price')}}:</div>
                                    </div>
                                    <div class="col-sm-12">
                            ...
                            <div class="mt-2">
                                @if ($qty > 0)
                                    ...
                                    <!-- <button type="button" class="btn btn-primary buy-now fw-600" onclick="window.location.href = '{{url("Contact")}}'">
                            ...
                            <div class="row no-gutters mt-4">
                                <div class="col-sm-12">
                                    <div class="opacity-50 my-0">{{ translate('Share')}}:</div>
                                </div>
                                <div class="col-sm-12">
    ...
    <section class="pt-4 pb-5 bg-sec-light">
        <div class="container">
            <div class="row gutters-10">
                <div class="col-xl-3 order-1 order-xl-0">
                    <!-- <div class="bg-white shadow-lg mb-3">
                    ...
                    <div class="bg-white rounded shadow-lg mb-3">
                        <h4 class="pt-3 px-3 mb-0 fw-600 uppercase">
                ...
                <div class="col-xl-9 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-lg rounded">
                    ...
                    <div class="bg-white rounded shadow-lg">
                        <div class="p-3">
                            <h3 class="fw-600 mb-0 uppercase">
                                <span class="mr-4">{{ translate('Related products')}}</span>
                            </h3>
                        </div>
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="4" data-xl-items="3" data-lg-items="3"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                ...
                                <div class="carousel-box">
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1 uppercase mb-0 h-35px">

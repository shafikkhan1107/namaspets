...
@section('content')
    ...
    <section class="py-5 bg-sec-light">
                        ...
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                ...
                                <div class="bg-white shadow-lg rounded mb-3">
                                    <h3 class="fs-13 uppercase fw-600 pt-3 px-3 pb-0">
                                ...
                                @foreach ($attributes as $key => $attribute)
                                    @if (\App\Attribute::find($attribute['id']) != null)
                                        <div class="bg-white shadow-sm rounded mb-3">
                                            <div class="fs-13 uppercase fw-600 pt-3 px-3 pb-0">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="text-left">
                            <div class="d-flex align-items-center">
                                <div>
                                    <h1 class="h1 mb-1 fw-600 text-body">
                                        @if(isset($category_id))
                                            {{ \App\Category::find($category_id)->getTranslation('name') }}
                                        @elseif(isset($query))
                                            {{ translate('Search result for ') }}"{{ $query }}"
                                        @elseif(isset($todays_deal))
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-xl-block">
                                    <label class="mb-0 opacity-50 brand-fs">{{ translate('Brands')}}</label>
                                ...
                                <div class="form-group w-200px ml-0 ml-xl-3">
                                    <label class="mb-0 opacity-50 brand-fs">{{ translate('Sort by')}}</label>
                        ...
                        <div class="row gutters-10 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            @foreach ($products as $key => $product)
                                <div class="col mb-3">
                                    <div class="aiz-card-box h-100 border border-light rounded shadow-lg hov-shadow-md has-transition bg-white">
                                        ...
                                        <div class="pb-3 pt-0 px-3 text-left">
                                            <div class="fs-15">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1 uppercase mb-0">
